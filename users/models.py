...
class Profile(models.Model):
    ...
    about = models.TextField(verbose_name="Short bio", max_length=2000, blank=True, default="")
    ...
    team = models.CharField(verbose_name="Team", max_length=128, blank=True)

    # SKILLS
    skills_known = models.ManyToManyField(Skill, verbose_name="Known capacity", related_name="user_known_skils", blank=True)
    skills_available = models.ManyToManyField(Skill, verbose_name="Available capacity", related_name="user_available_skills", blank=True)
    skills_wanted = models.ManyToManyField(Skill, verbose_name="Wanted capacity", related_name="user_desired_skils",
                                           blank=True)
    
    # CONTACT
    contact = models.JSONField(null=True, blank=True, verbose_name="Contact methods")
    social = models.JSONField(null=True, blank=True, verbose_name="Social medias")
