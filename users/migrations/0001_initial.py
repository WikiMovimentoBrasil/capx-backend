    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_joined', models.DateTimeField(default=datetime.datetime(2023, 11, 14, 17, 42, 36, 637268), verbose_name='date joined')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organization_name_en', models.CharField(error_messages={'unique': "There's another organization with that name."}, max_length=256, null=True, unique=True, verbose_name='Organization name')),
                ('organization_name_pt_br', models.CharField(error_messages={'unique': "There's another organization with that name."}, max_length=256, null=True, unique=True, verbose_name='Organization name')),
                ('organization_name_pt', models.CharField(error_messages={'unique': "There's another organization with that name."}, max_length=256, null=True, unique=True, verbose_name='Organization name')),
                ('organization_name_es', models.CharField(error_messages={'unique': "There's another organization with that name."}, max_length=256, null=True, unique=True, verbose_name='Organization name')),
                ('organization_description', models.TextField(max_length=1024, verbose_name='Organization description')),
                ('organization_description_en', models.TextField(max_length=1024, null=True, verbose_name='Organization description')),
                ('organization_description_pt_br', models.TextField(max_length=1024, null=True, verbose_name='Organization description')),
                ('organization_description_pt', models.TextField(max_length=1024, null=True, verbose_name='Organization description')),
                ('organization_description_es', models.TextField(max_length=1024, null=True, verbose_name='Organization description')),
